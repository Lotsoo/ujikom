      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="../admin/fasilitas_kamar.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="../login/logout.php" onclick="return confirm('Apakah Admin <?= $_SESSION['nama_user']; ?> Yakin Ingin Keluar?')" class="nav-link">
